package br.com.java.javacore.ZZGcomportamentoporparametro.test;

import br.com.java.javacore.ZZGcomportamentoporparametro.classes.Carro;
import br.com.java.javacore.ZZGcomportamentoporparametro.predicate.CarrosCorVerdePredicate;
import br.com.java.javacore.ZZGcomportamentoporparametro.predicate.CarrosDezAnosRecentePredicate;
...
public class CarroTest {
    ...
    private static List<Carro> filtrarCarroPelaCor(List<Carro> carros, String cor) {
        List<Carro> result = new ArrayList<>();
        for (Carro carro : carros) {
    ...
    public static List<Carro> filtrarCarros(List<Carro> carros, Predicate<Carro> carroPredicate) {
        List<Carro> result = new ArrayList<>();
        for (Carro carro : carros) {
    ...
    public static void main(String[] args) {
        ...
        List<Carro> carros = asList(new Carro("verde", 2011), new Carro("vermelho", 1985), new Carro("Preto", 2017));
        ...
        System.out.println(filtrarCarroPelaCor(carros, "verde"));
        System.out.println(filtrarCarroPelaCor(carros, "vermelho"));
